...
describe "In the parsers" do
  ...
  describe "BrowserEngine" do
    it "should extract engine name" do
      ...
      detector = DeviceDetector::BrowserEngineStore.new user_agent
  ...
  describe "Browser" do
    it "shoud extract browser name and version" do
      user_agent = "Mozilla/5.0 (Windows NT 6.4; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/36.0.1985.143 Safari/537.36 Edge/12.0"
      detector = DeviceDetector::BrowserStore.new user_agent
  ...
  describe "Camera" do
    it "should extract vendor and device" do
      ...
      detector = DeviceDetector::CameraStore.new user_agent
      result = detector.call
  ...
  describe "CarBrowser" do
    it "should extract model name and vendor" do
      ...
      detector = DeviceDetector::CarBrowserStore.new user_agent
      result = detector.call
  ...
  describe "Console" do
    it "should extract vendor and model name" do
      ...
      detector = DeviceDetector::ConsoleStore.new user_agent
      result = detector.call
  ...
  describe "FeedReader" do
    it "should extract name and version" do
      ...
      detector = DeviceDetector::FeedReaderStore.new user_agent
      result = detector.call
  ...
  describe "Library" do
    it "should extract name and version" do
      ...
      detector = DeviceDetector::LibraryStore.new user_agent
      result = detector.call
  ...
  describe "Mediaplayer" do
    it "should extract name and version" do
      ...
      detector = DeviceDetector::MediaplayerStore.new user_agent
      result = detector.call
  ...
  describe "MobileApp" do
    it "should extract name and version" do
      ...
      detector = DeviceDetector::MobileAppStore.new user_agent
      result = detector.call
  ...
  describe "Mobile" do
    it "should extract vendor, model and type" do
      ...
      detector = DeviceDetector::MobileStore.new user_agent
      result = detector.call
  ...
  describe "OSS" do
    it "should extract name and version" do
      ...
      detector = DeviceDetector::OSSStore.new user_agent
      result = detector.call
  ...
  describe "PIM" do
    it "should extract name and version" do
      ...
      detector = DeviceDetector::PIMStore.new user_agent
      result = detector.call
  ...
  describe "Portable media player" do
    it "should extract vendor and model" do
      ...
      detector = DeviceDetector::PortableMediaPlayerStore.new user_agent
      result = detector.call
  ...
  describe "TV" do
    it "should extract vendor and model" do
      ...
      detector = DeviceDetector::TelevisionStore.new user_agent
      result = detector.call
  ...
  describe "VendorFragment" do
    it "should extract vendor" do
      ...
      detector = DeviceDetector::VendorFragmentStore.new user_agent
      result = detector.call
